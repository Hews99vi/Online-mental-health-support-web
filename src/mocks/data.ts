...
export const SEED_CRISIS_RESOURCES = {
    guidanceText: 'You are not alone.\n\nMany people experience moments of overwhelming distress. Help is available right now.',
    hotlines: [
        { name: 'National Mental Health Helpline', number: '1926', available: '24/7', description: 'Free, confidential support in Sinhala, Tamil, and English.' },
        { name: 'Sumithrayo', number: '+94 11 269 6666', available: '24/7', description: 'Befriending and emotional support.' },
        { name: 'Emergency Services', number: '119', available: '24/7', description: 'For immediate physical danger.' },
    ],
};
