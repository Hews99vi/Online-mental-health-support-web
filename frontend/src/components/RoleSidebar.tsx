...
const NAV_CONFIG: Record<AppRole, NavItem[]> = {
    ...
    therapist: [
        ...
        { label: 'Client Messaging', path: '/therapist/messages', icon: '💬' },
        { label: 'Mood Insights', path: '/therapist/mood-insights', icon: '📈' },
        { label: 'Resource Assignments', path: '/therapist/resources', icon: '📚' },
        { label: 'Profile', path: '/profile', icon: '👤' },
    ],
    admin: [
        { label: 'Dashboard', path: '/admin', icon: '⊞' },
        { label: 'Therapist Approvals', path: '/admin/therapists', icon: '✅' },
        { label: 'Listener Approvals', path: '/admin/listeners', icon: '🎧' },
